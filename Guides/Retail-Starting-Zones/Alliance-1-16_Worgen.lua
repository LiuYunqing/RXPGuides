...
step
    #completewith next
    +欢迎使用RestedXP提供的|cFFfa9602Worgen Starting Zone|r指南。
...
step
    ...
    .accept 75190 >>接任务: |cRXP_WARN_[Ready and Abel]|r << Monk --Added in DF
	.target Gwen Armstead
step << skip
    #completewith next
...
step << Monk
    ...
    .accept 75189 >>接任务: |cRXP_WARN_人多安全|r
    .target Todd Abel
step
    ...
    .turnin 75189 >>交任务: |cRXP_FRIENDLY_人多安全|r << Monk
...
step
    ...
    .goto 182,43.87,15.56,6 >>登上庄园的塔顶
step
    #label AlasGilneas
...
step
    ...
    .goto 179,28.90,54.22,15 >>下塔，然后离开格雷曼庄园。向下跳向|cRXP_FRIENDLY_Stagecoach车厢|r
step
    .goto 179,28.90,54.22
    >>输入|cRXP_FRIENDLY_Stagecoach Carriage|r
...
step
    ...
    .goto 180,54.26,81.11,10 >>前往|cRXP_ENEMY_Brothogg内部的奴隶主|r
    .isOnQuest 24674
step
    #label Brothogg
...
step
    ...
    >>如果你不小心攻击了任何暴徒或需要清除路径，请输入附近的|cRXP_FRIENDLY_Emberstone Cannon|r 
    >>在|cRXP_FRIENDLY_Emberstone Cannon|r中时：
    >>施法|T252185:0|t[Emberstone Cannon]（1）（远程瞬变：造成大量伤害）
    >>|cRXP_WARN_使用|r|T135340:0|t[Gilnean Patriots]|cRXP_WARN_on您的|cRXP_FRIENDLY_Gilnean Militia|r守护者来增加他们的速度和生命恢复|r
    .goto 202,61.86,70.83,30 >>前往|cRXP_ENEMY_Gorerot|r
...
-- .goto 202,68.34,82.00,15,0
    +进入附近|cRXP_FRIENDLY_Damaged弹射器|r
    >>在|cRXP_FRIENDLY_Damaged弹射器|r中时：
    >>施法|r|T132386:0|t[狂暴巨石]（1）（范围瞬间：应用|r|T132386:0 |t[凶猛巨石]减持，造成30秒以上的火焰伤害，不叠加）。每30秒刷新一次debuff，造成大量伤害
    .target Damaged Catapult
    .use 50334
step
    #label Gorerot
    .goto 202,57.73,66.59
    >>杀死|cRXP_ENEMY_Gorerot|r
    >>|cRXP_WARN_不要担心被他攻击，因为你有|r|T236310:0|t[吉尔诺斯城之战的士兵]|cRXP_WARN_buff（被动光环：极大地增加速度、生命值再生和资源再生）|r
    >>|cRXP_WARN_使用|r|T135340:0|t[Gilnean Patriots]|cRXP_WARN_on您的|cRXP_FRIENDLY_Gilnean Militia|r守护者来增加他们的速度和生命恢复|r
...
step
    ...
    .goto 202,36.17,62.68,50 >>前往|cRXP_ENEMY_Lady Sylvanas Windrunner|r
step
    .goto 202,36.17,62.68
    >>杀死|cRXP_ENEMY_Soultethered Banshees|r
    >>击败|cRXP_ENEMY_Lady Sylvanas Windrunner|r，使其生命值低于30%
...
step
    #completewith next
    .goto 57,52.28,89.47
    .zone 12 >>单击|cRXP_PICK_Portal到Exodar|r
    .zoneskip 37
    .zoneskip 84
    .zoneskip 103
    .nodmf

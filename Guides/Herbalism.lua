...
step << !mage
    ...
    .fly Warsong Hold >>飞往北方苔原（Warsong Hold）
    .skill herbalism,375,1
    .skill riding,300,1
    .zoneskip Borean Tundra
step
    ...
    .train 50300 >>在Warsong Hold向Tansy Wildmane学习草药大师（350-450）
    .skill herbalism,375,1
step
    #label BoreanTundra
    .skill herbalism,375 >>将你的草药水平从350-400在北方苔原
...
step
    .skill herbalism,425 >>在Sholazar盆地从375-425升级草药
...
step
    #label TheStormPeaks
    .skill herbalism,450 >>在风暴峰中从425-450升级草药
...
step
    ...
    .train 50300 >>在Valiance Keep向Kirea月光舞者学习草药大师（350-450）
    .skill herbalism,400,1
step
    #label BoreanTundra
    .skill herbalism,400 >>将你的草药水平从350-400在北方苔原
    .loop 20,Borean Tundra,77.0,30.1,77.5,35.8,75.5,41.7,69.0,41.8,64.5,39.8,60.7,42.5,61.6,58.4,57.4,48.8,49.8,69.5,49.2,74.9,46.2,72.2,32.8,63.5,32.5,54.3,44.0,43.9,52.7,49.0,52.7,41.0,58.0,40.4,60.1,32.5,54.9,27.9,48.4,23.2,50.0,20.0,58.1,18.7,61.8,14.3,66.0,16.1,73.4,25.9,70.1,31.0,72.6,34.2,77.0,30.1
step
    #completewith next
    .goto Sholazar Basin,50,50

...
step
    >>杀死塔布克和克莱夫蹄，然后剥下它们的皮
    .skill skinning,350 >>在Nagrand从330-350开始平整你的皮肤
...
step << !Mage
    ...
    .fly Taunka'le Village >>飞往Borean Tundra（Taunka'le村）
    .skill skinning,375,1
    .skill riding,300,1
    .zoneskip Borean Tundra
step
    ...
    .train 50305 >>从Taunka'le村的Tiponi Stormweer学习Skinning大师（350-450）
    .skill skinning,375,1
step
    #label BoreanTundra
    .skill skinning,375 >>在Borean Tundra从350-375开始平整你的皮肤
...
step << !Mage
    #completewith next
    .goto Dalaran,71.8,45.6
    .fly The Argent Stand >>飞往祖德拉克（银色看台）
    .skill skinning,400,1
    .skill riding,300,1
    .zoneskip Borean Tundra
step
    #label ZulDrak
    .skill skinning,400 >>在Zul'Drak中，将你的皮肤从375-400变平
...
step
    .skill skinning,400 >>在风暴峰中，将你的皮肤从400-450调平
...
step
    >>杀死塔布克和克莱夫蹄，然后剥下它们的皮
    .skill skinning,350 >>在纳格兰从330-375开始平整您的皮肤
    .loop 45,Nagrand,51.3,37.6,52.3,33.6,54.1,30.0,52.8,26.1,50.6,25.3,48.4,26.8,46.6,27.2,46.6,33.6,46.5,40.3,47.0,45.1,49.2,49.2,53.5,53.8,55.3,52.8,57.3,49.8,60.1,48.4,62.0,46.1,60.6,43.4,57.9,42.5,54.7,42.5,52.7,40.7,51.3,37.6
step << Mage
    #completewith next
    .zone Dalaran >>前往: |cRXP_PICK_达拉然|r
...
step
    ...
    .fly Valiance Keep >>飞往博伦苔原（英勇守护）
    .skill riding,300,1
    .skill skinning,375,1
step
    #completewith next
    .goto Borean Tundra,57.6,71.8 >>飞到你的飞行坐骑上的北安苔原的勇士城堡
    .skill riding,<300,1
    .skill skinning,375,1
step
    #label Jack
    .train 50305 >>在英勇要塞向陷阱杰克学习剥皮大师（350-450）
    .skill skinning,375,1
step
    .skill skinning 375 >>在Borean Tundra中从350-375开始平整您的蒙皮
    .loop 20,Borean Tundra,47.3,39.4,44.7,39.8,42.2,42.6,40.6,42.8,42.1,48.0,42.2,48.9,47.9,48.0,47.3,39.4
    .loop 20,Borean Tundra,49.7,74.3,43.4,76.4,40.1,73.8,40.6,70.3,45.8,69.7,48.7,68.9,50.7,66.7,52.1,68.7,49.7,74.3
step << Mage
    #completewith next

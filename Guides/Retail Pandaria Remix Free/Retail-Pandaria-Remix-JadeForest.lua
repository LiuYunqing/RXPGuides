...
--     .goto 371,42.5,27.32
--     .accept 78894 >>接任务: |cRXP_WARN_永恒壮大|r
--     .target Momentus
step
    #completewith next
...
step
    ...
    .accept 29618 >>接任务: |cRXP_WARN_拜会长老|r
step
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Lin Tenderpaw|r
    .accept 29619 >>接任务: |cRXP_WARN_谦谦来客|r
    .target Lin Tenderpaw
step
    #loop
    ...
    >>杀死|cRXP_ENEMY_Greenwood盗贼|r掠夺它们以获取|cRXP_Loot_熟橙|r
...
step
    ...
    .target Lin Tenderpaw
    .accept 29620 >>接任务: |cRXP_WARN_盛大的宴会|r
step
    #completewith next
...
step
    ...
    .target Master Stone Fist
    .accept 29633 >>接任务: |cRXP_WARN_灵巧的齐齐|r
    .accept 29634 >>接任务: |cRXP_WARN_枯瘦的胡苏安|r
step
    #completewith next
...
step
    ...
    .accept 29635 >>接任务: |cRXP_WARN_贪吃的晓|r
    .goto 371,43.24,24.76
    .target Master Stone Fist
step
    .isOnQuest 29633
...
step
    ...
    .target Master Stone Fist
    .accept 29636 >>接任务: |cRXP_WARN_耐力的试炼|r
step
    .solo
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Instructor Xann|r
    .turnin 29622 >>Turn in Your Training Starts Now
    .accept 29623 >>接任务: |cRXP_WARN_臻于完美|r
    .target Instructor Xann
step
    .group
    .goto 371,41.61,28.34
    >>|cRXP_WARN_使|cFFFF0000角色|r远离训练场，并将|cFFFFFFF0000相机|r对准它。|r
...
step
    ...
    .target Instructor Xann
    .accept 29624 >>接任务: |cRXP_WARN_保持专注|r
step
    .group
...
step
    ...
    .accept 29627 >>接任务: |cRXP_WARN_称手的武器|r
step
    #completewith --3/3 Triple-Bittered Ale
    >>单击|cRXP_PICK_Bambus|r
...
step
    ...
    --.accept 29628 >>接任务: |cRXP_WARN_强壮的后背|r
    .accept 29629 >>接任务: |cRXP_WARN_稳健的双手|r
    .accept 29630 >>接任务: |cRXP_WARN_沉重的拳头|r
    .target Groundskeeper Wu
step
    ...
    --.accept 29637 >>接任务: |cRXP_WARN_大乱斗|r
-- step
--     .isOnQuest 29637
--     .goto 371,38.98,23.82
--     .cast 102953 >>在魔戒内使用|T134273:0|t[修道院烟花]。
--     .timer 120,RP
--     .use 73369
-- step
...
step
    ...
    .accept 29631 >>接任务: |cRXP_WARN_明亮地燃烧|r
...
-- step << Alliance
--     #completewith ScrollIntro
--     >>杀死|cRXP_ENEMY_Greenwood骗子|r
--     .complete 29630,1 --10/10 Greenwood Trickster slain
--     .mob greenwood trickster
-- step << Alliance
--     #completewith ScrollIntro
--     >>杀死|cRXP_ENEMY_Waxwood猎人|r
--     .complete 29631,1 --6/6 Waxwood Hunter slain
--     .mob waxwood hunter
-- step << Alliance
--     #label ScrollIntro
--     >>单击|cRXP_PICK_Bushleaf簇|r|cRXP-WARN_并等待通道结束（不允许移动、转动或角色）|r
--     .complete 29629,1 --80/80 Blushleaf Extract
-- step << Alliance
--     #completewith next
--     .cast 374990 >>安装在您的龙之坐骑上并使用|T134156:0|t[青铜时间锁]
-- step << Alliance
--     .goto 371,26.39,28.33
--     .achievement 6850,1 >>单击|cRXP_PICK_Scroll|r
-- step << Alliance
--     .isOnQuest 29629
--     .cast 374994 >>安装在您的Dragonriding Mount上并使用|T4640479:0|t[青铜倒带]
step
    #hidewindow
...
--    >>|cRXP_WARN_返回釜|r，但注意不要将绳索|cRXP_WARN_beyond拉伸100码，以免断开连接。|r
--    .complete 29628,2 --1/1 Boiling Cauldron returned
step
    ...
    --.accept 29646 >>接任务: |cRXP_WARN_流光溢彩|r
    .target Groundskeeper Wu
--step
...
step
    ...
    .accept 29747 >>接任务: |cRXP_WARN_打破循环|r
step
    .goto 371,48.57,20.63
    >>单击|cRXP_PICK_Mogu头|r
    .accept 29748 >>接任务: |cRXP_WARN_灵俑破灭|r
...
step
    #completewith next
    >>单击|cRXP_PICK_Statues|r
    .complete 29748,1 --6/6 Vacant Destroyer Kicked
step
    >>杀死|cRXP_ENEMY_Shan'ze Spiritbinder|r
...
step
    ...
    .accept 29749 >>接任务: |cRXP_WARN_迫切的恳求|r
step
    .goto 371,44.23,14.95
    >>单击|cRXP_PICK_Staff|r
    .complete 29749,1 --1/1 Staff of Pei-Zhi
    -- .timer 100,RP
step
    .goto 371,44.363,15.629
    >>杀死|cRXP_ENEMY_Ancient Spirits|r直到任务完成（你必须杀死20个暴徒才能填满酒吧）。
    .complete 29749,2 --1/1 Interrupt the Ritual of Spiritbinding
    .mob Ancient Spirit
step
    #completewith next
    .logout >>|cRXP_WARN_Press Escape并选择“注销”|r等待您可以重新登录以跳过角色扮演。
step
    ...
    .accept 29750 >>接任务: |cRXP_WARN_灵魂的容器|r
    .accept 29751 >>接任务: |cRXP_WARN_仪式神器|r
    .accept 29752 >>接任务: |cRXP_WARN_倔强的死者|r
    .target Pei-Zhi
--x step add treasure
step
    #completewith Chipped Ritual Bowl
    >>杀死|cRXP_ENEMY_Shan'ze灵爪|r为|T461804:0|t[|cRXP_Loot_Spirit Bottles|r]掠夺它们。
    .complete 29750,1 --8/8 Spirit Bottle
    .mob Shan'ze Spiritclaw
step
    #completewith Chipped Ritual Bowl
    >>单击|cRXP_ENEMY_Wayward Ancestor|r|cRXP-WARN_您可以在施法过程中行走|r
    .complete 29752,1 --10/10 Wayward Ancestors Recovered
    .use 74771
    .mob Wayward Ancestor
step
    .goto 371,42.69,15.75
    >>单击|cRXP_PICK_Jade Cong|r
    .complete 29751,1 --1/1 Jade Cong
step
    .goto 371,42.28,17.1
    >>单击|cRXP_PICK_Candle|r
...
step
    #label Spirit Bottle
    >>杀死|cRXP_ENEMY_Shan'ze灵爪|r为|cRXP_Loot_Spirit Bottles|r抢劫它们。
    .complete 29750,1 --8/8 Spirit Bottle
    .mob Shan'ze Spiritclaw
step
    ...
    .accept 29753 >>接任务: |cRXP_WARN_重归自然|r
    .accept 29756 >>接任务: |cRXP_WARN_寒酸的供品|r
    .target Pei-Zhi
step
    #xprate <2
...
step
    #xprate <2
    #completewith next
    >>单击|cRXP_PICK_Tidemist Caps|r
    .complete 29756,1 --10/10 Tidemist Cap
step
    #xprate <2
    >>冷却时在地面上使用|T461804:0|t[水瓶]|cRXP_WARN_on|r杀死新兴的|cRXP_ENEMY_暴怒的野兽精灵。|r
...
step
    ...
    --.accept 29754 >>接任务: |cRXP_WARN_沟通天地|r
    .timer 147,RP
    .target Pei-Zhi
--step
...
--    .accept 29755 >>接任务: |cRXP_WARN_裴智归来|r
--step
--    .goto 371,42.51,10.62
--    >>击败|cRXP_ENEMY_Stonebound Colossus |r。当|cRXD_ENEMY_Shan Jitong|r将你从石像上撕下时，|cRXP_WARN_Return to your body-soul。
--    >>最后杀死|cRXP_ENEMY_单冀彤|r
...
step
    ...
    .accept 29578 >>接任务: |cRXP_WARN_抗争|r
    .accept 29579 >>接任务: |cRXP_WARN_集结幸存者|r
...
step
    ...
    .accept 29580 >>接任务: |cRXP_WARN_果园里的装备|r
    .accept 29585 >>接任务: |cRXP_WARN_火花四溅|r
...
step
    ...
    >>杀死|cRXP_ENEMY_Gormali袭击者|r和|cRXP_ENEMY_Gormali焚烧炉|r|cRXP_WARN_优先考虑那些与|cRXP_FRIENDLY_Nectarbrize Farmers作战的人|r
...
step
    #completewith Orchard Fires
    >>单击|cRXP_PICK_Gardening Tools|r
...
step
    #label Orchard Fires
    >>使用|T463863:0|t[Nectarbreeze Cider]|cRXP_WARN_on附近的火|r
...
step
    ...
    .accept 29586 >>接任务: |cRXP_WARN_崎岖小路|r
...
step
    ...
    .accept 29587 >>接任务: |cRXP_WARN_释放俘虏|r
    .accept 29670 >>接任务: |cRXP_WARN_以暴制暴|r
    .target Shao the Defiant
step
    #completewith next
    >>通过与|cRXP_PICK_Net|r交互并杀死与之相连的|cRXP_ENEMY_Gormali奴隶|r，释放|cRXP_FRIENDLY_Captured Nectarbreeze Farmer|r。
...
step
    ...
    .goto 371,37.8,76.19
    >>杀死|cRXP_ENEMY_Subjugator Gormal|r
...
--     .accept 80311 >>接任务: |cRXP_WARN_[Order of the Cloud Serpent]|r
...
step
    ...
    .accept 30134 >>接任务: |cRXP_WARN_局势失控|r
    .target Elder Anli
step
    #completewith next
    .goto 371,65.25,37.20,20,0
...
step
    ...
    .accept 30135 >>接任务: |cRXP_WARN_放手一搏|r
    .accept 30136 >>接任务: |cRXP_WARN_空荡荡的巢穴|r
    .accept 30137 >>接任务: |cRXP_WARN_收集龙蛋|r
...
step
    .isOnQuest 30136
    .cast 110171 >>与|cRXP_FRONDLY_Windward Hatchling|r|cRXP-WARN_[1]|r交互
    .use 78947
    .target Windward Hatchlings
step
    .isOnQuest 30136
    .cast 110171 >>与|cRXP_FRONDLY_Windward Hatchling|r|cRXP-WARN_[2]|r交互
    .use 78947
    .target Windward Hatchlings
step
    .isOnQuest 30136
    .cast 110171 >>与|cRXP_FRONDLY_Windward Hatchling|r|cRXP-WARN_[3]|r交互
    .use 78947
    .target Windward Hatchlings
step
    .isOnQuest 30136
    .cast 110171 >>与|cRXP_FRONDLY_Windward Hatchling|r|cRXP-WARN_[4]|r交互
    .use 78947
    .target Windward Hatchlings
step
    .isOnQuest 30136
    .cast 110171 >>与|cRXP_FRONDLY_Windward Hatchling|r|cRXP-WARN_[5]|r交互
    .use 78947
    .target Windward Hatchlings
step
    #label Interact with Windward Hatchlings
    .isOnQuest 30136
    .cast 110171 >>与|cRXP_FRONDLY_Windward Hatchling|r|cRXP-WARN_[6]|r交互
    .use 78947
    .target Windward Hatchlings
step
...
step
    ...
    .accept 30138 >>接任务: |cRXP_WARN_选择龙蛋|r
    .turnin 30138 >>Turn in Choosing the One
step
    .goto 371,65.34,31.64
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Instructor Tong.|r
    .accept 30140 >>接任务: |cRXP_WARN_骑士之旅|r
    .itemcount 78960,1
    .target Instructor Tong
step
    .goto 371,65.34,31.64
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Instructor Tong.|r
    .accept 30141 >>接任务: |cRXP_WARN_骑士之旅|r
    .itemcount 78961,1
    .target Instructor Tong
step
    .goto 371,65.34,31.64
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Instructor Tong.|r
    .accept 30139 >>接任务: |cRXP_WARN_骑士之旅|r
    .itemcount 78962,1
    .target Instructor Tong
step
...
step
    ...
    .goto 371,57.55,45.10
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Instructor Skythorn|r
    .accept 30142 >>接任务: |cRXP_WARN_这是个……|r
...
#version 1
#group RestedXP Panda Remix
#name 1） Pandaria混音调平指南：如何使用和基本提示
#next 2） Pandaria混音简介
-- #subweight 11
...
step
    #completewith test
    +|cFFFF0000重要提示：|r|cRXP_WARN_仔细阅读每一节，并单击指南以获取详细提示和策略|r
step
    #label test
    +|T623705:0|t[Cloak of Infinite Potential]是此次活动的关键项目。以下是它的工作原理以及如何最大限度地发挥其潜力：
step
    +|cRXP_WARN_Acquisition:|r从初始任务线获得|T623705:0|t[无限潜能的斗篷]。
step
    +|cRXP_WARN_Stat增益：|r斗篷通过各种活动获得属性：
...
step
    +|cRXP_WARN_Stat增加机制：|r从各种活动中获得的每个Stat增加都是随机的。虽然你可能会很幸运，并在早期收到很多你想要的统计数据，但请放心，通过持续参与这些活动，你最终会完全升级你的斗篷。
    ...
    *Experience Gain %
step
    +|cRXP_WARN_Experience增益%：|r这是快速升级的最重要的统计数据。增加你的经验增益%将显著提高你的平衡速度。
...
step
    +|cRXP_WARN_魔兽世界中的宝石混音：潘达里亚的迷雾|r
step
    +|cRXP_WARN_在魔兽世界混音：潘达里亚迷雾事件中，|r宝石在增强角色能力和定制游戏体验方面发挥着至关重要的作用。
step
    +玩家可以通过|cRXP_WARN_攻击敌人|r并打开|cRXP-FRIENDLY_|T1542852:0|t无限宝藏之切|r获得四种宝石
step
    +|cRXP_WARN_Meta宝石：|r这些宝石适合头盔设备插槽，提供独特、强大的使用能力和强大的破坏力。
step
    +|cRXP_WARN_GWheel宝石：|r这些宝石适合放在脚部装备槽中，并增强标志性的移动速度能力，如流氓的冲刺或僧侣的翻滚。
step
    +|cRXP_WARN_Tinker宝石：|r这些宝石适合佩戴在肩部、腰带、手腕和手套装备槽中，提供独特而强大的被动能力。
step
    +|cRXP_WARN_魅力宝石：|r这些宝石适合放在胸部、腿部、项链、戒指和小饰品设备插槽中。
    *|cRXP_WARN_Prismatic Gems provide a range of stats from main stat to secondary stats.|r
step
    +在调平过程中特别有用的宝石是|T839974:0|t[雷神之珠]、|T236172:0|t]开拓者]和|T236209:0|t[脆性]。
step
    +|cRXP_WARN_|T4638724:0|t[青铜]魔兽世界混音：潘达里亚的迷雾|r
step
    +|cRXP_WARN_In魔兽世界混音：潘达里亚迷雾|r|T4638724:0|t[青铜]是一种用于升级物品和购买化妆品的特殊货币。
    *Here's a detailed explanation of how Bronze works and its role in the event:
step
    +|cRXP_WARN_收购|T4638724:0|t[青铜]|r
...
step
    +|cFFFF0000TLDR：永远掠夺每一个敌人，永远不要忘记穿上你的斗篷|r
step
    +指南将指导您购买宝石并升级您的装备。
...
step
    +在停机期间，通常被称为角色扮演或RP，指南将指示您报废、提取宝石、打开|cRXP_FRIENDLY_|T1542852:0|t无限宝藏之旅|r并装备新装备和宝石。
...
step
    ...
    .accept 79433 >>接任务: |cRXP_WARN_专业咨询|r
    .target Eternus
step
    ...
    .accept 79434 >>接任务: |cRXP_WARN_深织我心|r
    .accept 79437 >>接任务: |cRXP_WARN_时不关己|r
    .target Moratari
step
    #completewith Time Rift
    >>杀死|cRXP_ENEMY_Infinite Ravagers|r。掠夺它们获得|cRXX_Loot_Threads of Time|r
    .complete 79434,1 --3/3 Thread of Time
    .mob Infinite Ravager
step
    .goto 554,22.95,55.54
    >>单击|cRXP_PICK_Time Rift|r
...
step
    ...
    .accept 79435 >>接任务: |cRXP_WARN_有时同享|r
    .target Moratari
step
...
step
    ...
    .accept 80380 >>接任务: |cRXP_WARN_手中线，身上披|r
    .target Moratari
step
    .goto 554,24.0,55.4,40,0
    .goto 554,22.4,43.4,40,0
...
step
    ...
    .goto 554,24.0,55.4,0
    .goto 554,22.4,43.4,0
    >>杀死|cRXP_ENEMY_Infinite Ravagers|r。掠夺他们获得|cRXX_Loot_力量之线|r
...
step
    ...
    .target Moratari
    .accept 79438 >>接任务: |cRXP_WARN_永生之人伤离别|r
step
    .goto 554,25.71,58.11
    >>杀死|cRXP_ENEMY_Eratus，解开的悖论|r
...
step
    ...
    .target Moratari
    .accept 79440 >>接任务: |cRXP_WARN_战火回忆|r
step
...
step
    ...
    .accept 29690 >>接任务: |cRXP_WARN_深入迷雾|r
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_General Nazgrim|r
    .turnin 29690 >>交任务: |cRXP_FRIENDLY_深入迷雾|rs
    .target General Nazgrim
    .accept 31765 >>接任务: |cRXP_WARN_血染滩头！|r
step
    #completewith next
...
step
    ...
    .vehicle 66183 >>进入炮舰炮塔
step
    >>杀死|cRXP_ENEMY_Thunder Hold Cannon|r和|cRXX_ENEMY_ Thunder Hold Soldier|r
    >>垃圾邮件|T132385:0|t[碎纸机回合]（2），冷却时使用|T249177:0|t[Full Autofire]（1）
...
step
    ...
    .accept 31766 >>接任务: |cRXP_WARN_天降神兵|r
step
    >>单击|cRXP_PICK_Rappeling绳索|r
...
step
    ...
    .accept 31767 >>接任务: |cRXP_WARN_干掉他们！|r
    .accept 31768 >>接任务: |cRXP_WARN_火总是那么管用|r
    .target General Nazgrim
step
...
step
    #completewith next
    >>杀死|cRXP_ENEMY_Thunder Hold Menders|r，|cRXD_ENEMY_ Thunder Hold Cannoneers|r，和|cRXX_ENEMY_迅雷Hold Armmans|r
...
step
    >>使用|T134538:0|t[纳粹火炬枪]摧毁|cRXP_PICK_Thunder Hold弹药|r
    .use 89605
...
step
    ...
    .accept 31769 >>接任务: |cRXP_WARN_致命一击！|r
step
    >>使用|T134538:0|t[纳粹火炬枪]摧毁|cRXP_PICK_Barricade|r
    .use 89769
...
step
    #completewith next
    +|cRXP_WARN_要有效地学习龙骑天赋，请使用“点击此处”下的宏|r
    .link /run GenericTraitUI_LoadUI();GenericTraitFrame:SetSystemID(1);ToggleFrame(GenericTraitFrame) >>单击此处
step
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_General Nazgrim|r and |cRXP_FRIENDLY_Taran Zhu|r
    .accept 29694 >>接任务: |cRXP_WARN_重组！|r
    .accept 31770 >>接任务: |cRXP_WARN_要么服从要么……|r
    .goto 371,33.66,10.62
    .target +General Nazgrim
    .accept 31771 >>接任务: |cRXP_WARN_自食恶果|r
...
step
    ...
    >>杀死|cRXP_ENEMY_Sha Harbinger|r和|cRXX_ENEMY_Sha Haunt|r
...
step
    ...
    .accept 31978 >>接任务: |cRXP_WARN_酒最珍贵！|r
    .target Gi-Oh
step
...
step
    ...
    .accept 31773 >>接任务: |cRXP_WARN_徘徊者危机|r
    .target Kai-Lin Honeydew
step
    #completewith ShokiaRescued
    >>杀死|cRXP_ENEMY_Sha-Infested Prowler|r
...
step
    ...
    .accept 31774 >>接任务: |cRXP_WARN_寻找金祖恩|r
...
step
    ...
    .turnin 81638 >>交任务: |cRXP_FRIENDLY_炉石所指才是家|r
...
step
    ...
    .buy 217930,10
    .skipgossip
    .accept 81976 >>接任务: |cRXP_WARN_集市，对吧？|r
    .turnin 81976 >>接任务: |cRXP_WARN_集市，对吧？|r
    .target Nostwin
step
    .goto 371,28.53,14.01
...
step
    ...
    .goto 371,28.58,14.04,40 >>|cRXP_WARN_我们开始这个任务，将传送物品传送到这个区域。|r
    *单击|cRXP_PICK_蜜露村门户|r to go back.
    .itemcount 216712,1
step
    ...
    .accept 29765 >>接任务: |cRXP_WARN_视力衰弱|r
    .target Zin'Jun
step
    .goto 371,30.90,17.49
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to the |cRXP_FRIENDLY_Ancient Statue|r
    .accept 29743 >>接任务: |cRXP_WARN_怪物|r
    .target Ancient Statue
step
    #completewith Monstrosity
    >>杀死|cRXP_ENEMY_Hozen Groundpounders |r。掠夺他们|T135611:0|t[金的步枪]，|T237297:0|t[金军的左眼]，|T237299:0|t[金军的右眼]和|T134176:0|t[Sunff的尸体]
...
step
    ...
    .accept 29804 >>接任务: |cRXP_WARN_血债血偿|r
    .target Zin'Jun
step
...
step
    ...
    .accept 31775 >>接任务: |cRXP_WARN_突袭机坪|r
    .accept 31776 >>接任务: |cRXP_WARN_铁腕战术|r
    .target General Nazgrim
step
    .goto 371,31.41,21.77
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Merchant Zin|r
    .accept 31778 >>接任务: |cRXP_WARN_是敌非友|r
    .target Merchant Zin
step
    .goto 371,31.13,21.58
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Rivett Clutchpop|r
    .accept 31777 >>接任务: |cRXP_WARN_土制火箭筒|r
    .target Rivett Clutchpop
...
step
    #completewith next
    #label Cogswing
    >>杀死|cRXP_ENEMY_主工程师Cogswing|r和|cRXP-ENEMY_Gyro-Mechanic Lavenderp|r
...
step
    #completewith Cogswing
    #label Grimhatchet
    >>杀死|cRXP_ENEMY_Morgus Grimhatchet|r
...
step
    ...
    >>杀死|cRXP_ENEMY_下士Jackson Silver|r
...
step
    ...
    >>拿起|T133837:0|t[必需的烟花发射器]|cRXP_WARN_一次只能携带4个|r
    >>|cRXP_WARN_Click on the |cRXP_ENEMY_Strongarm Gyrocopters |r on the air |r（you can just Right Click they）
    .use 89163
...
step
    ...
    .accept 31779 >>接任务: |cRXP_WARN_掘地三尺|r
    .target General Nazgrim
step
    #completewith next
    .goto 371,26.00,24.43,10 >>进入桥后的洞穴
step
    .goto 371,25.76,23.64
    >>杀死|cRXP_ENEMY_多伦上尉|r
...
step
    ...
    .accept 31999 >>接任务: |cRXP_WARN_纳兹戈林的命令|r
    .target Flagpole
step
...
step
    ...
    .accept 29815 >>接任务: |cRXP_WARN_法医学|r
    .goto 371,28.19,24.83
    .target +Shademaster Kiryn
    .accept 29821 >>接任务: |cRXP_WARN_差那么一点……就打中我了！|r
    .goto 371,28.10,24.70
    .target +Rivett Clutchpop
step
    #completewith next
    >>拾取|T132108:0|t[潜伏的花朵]|cRXP_WARN_（安装时可能）|r
...
step
    ...
    .accept 31112 >>接任务: |cRXP_WARN_问题变得棘手了！|r
...
step
    #completewith next
    >>单击|cRXP_PICK_Lurching Blossoms|r|cRXP-WARN_（安装时可能）|r
    .complete 29815,1 --8/8 Viscous Chlorophyll
    .target Lurching Blossom
step
    #label EmergencySupplies
    >>杀死|cRXP_ENEMY_Water Sprites|r。为|T348523:0|t[应急物资]掠夺它们
...
step
    ...
    .accept 29827 >>接任务: |cRXP_WARN_酸雨|r
...
step
    ...
    .vehicle 55676 >>安装|cRXP_FRIENDLY_复盖陀螺仪|r
    .target Recovered Gyrocopter
step
    .goto 371,28.07,24.79
    >>|cRXP_WARN_在一大群暴徒上方使用|r|T237521:0|t[毒花]（2）|cRXP_WARN_while|r|cRXP_WARN_Use|r|T135431:0|t[投掷星]（1）|cRXX_WARN_to杀死单个暴徒。|r
    >>杀死|cRXP_ENEMY_Hozen Nibstabber |r和|cRXX_ENEMY_ Hozen Gutripper|r
...
step
    ...
    >>杀死|cRXP_ENEMY_Hozen Gutripper|r
    .mob Hozen Gutripper
step
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_General Nazgrim|r
    .accept 29822 >>接任务: |cRXP_WARN_事态|r
    .target General Nazgrim
step
    >>Follow the arrow
...
step
    .isOnQuest 29822
    .cast 3365 >>拿起井里的|T133784:0|t[幸运熊猫币]
    .goto 371,31.96,27.75
step
    .goto 371,27.80,30.28
    >>杀死|cRXP_ENEMY_Dook Ookem|r
...
step
    .isOnQuest 29822
    .cast 3365 >>拿起桌上的|T608949:0|t[古潘达伦茶壶]
...
step
    ...
    .accept 31732 >>接任务: |cRXP_WARN_天火降临|r
step
...
step
    ...
    .vehicle >>单击|cRXP_PICK_Skyfire陀螺仪|r
    .timer 25.5, RP
...
step
    ...
    .link /run GenericTraitUI_LoadUI();GenericTraitFrame:SetSystemID(1);ToggleFrame(GenericTraitFrame) >>单击此处
step
    >>使用|T249177:0|t[全自动射击（1）]，然后在|cRXP_ENEMY_Shreders|r、|cRXD_ENEMY_Peons|r和|cRXX_ENEMY_Grunts|r|cRXP_WARN_Idally上使用|T249977:0|t[鱼雷火箭（2）]，一次瞄准尽可能多的目标，如果它们离得很近，就瞄准它们|r
...
step
    ...
    >>在船上的油桶上使用|T249177:0|t[全自动射击（1）]或|T2491777:0|t]鱼雷火箭（2）]|cRXP_WARN_|r
...
step
    #completewith next
    .exitvehicle >>|cRXP_WARN_按下操作栏上的|r[Exit]|cRXP_WARN_button，卸下Skyfire Gyrotocopter。|r
...
step
    ...
    .target Sky Admiral Rogers
    .accept 31733 >>接任务: |cRXP_WARN_天降神兵|r
step
    .goto 371,42.32,92.79
    >>单击|cRXP_PICK_Skyfire降落伞|r
...
step
    ...
    .accept 30069 >>接任务: |cRXP_WARN_随机应变|r
    .accept 31734 >>接任务: |cRXP_WARN_摧毁战车|r
step
    #completewith next
    >>杀死|cRXP_ENEMY_Grunts|r和|cRXX_ENEMY_Gear-Greasers|r
...
step
    ...
    >>使用|T135619:0|t[Sully’s Flare Gun]|cRXP_WARN_near Horde War Wagons|r
...
step
    ...
    .accept 31735 >>接任务: |cRXP_WARN_物尽其用|r
    .target Rell Nightwind
step
    .goto 371,45.62,95.24
    >>使用|T135619:0|t[Sully’s Flare Gun]|cRXP_WARN_绕过路障|r
...
step
    ...
    .accept 31736 >>接任务: |cRXP_WARN_联盟使节|r
    .accept 31737 >>接任务: |cRXP_WARN_战争的代价|r
    .target Rell Nightwind
step
    #loop
    ...
    >>杀死|cRXP_ENEMY_Sha Haunt|r和|cRXP_ENEMY_Sha Harbinger|r
...
step
    ...
    .accept 31738 >>接任务: |cRXP_WARN_表明诚意|r
    .goto 371,46.26,84.73
    .target +Sunke Khang
    .accept 31739 >>接任务: |cRXP_WARN_酒最珍贵！|r
    .target +Teng Applebloom
    .goto 371,46.22,84.69
    .accept 29552 >>接任务: |cRXP_WARN_情况危急|r
...
step
    #completewith next
    .goto 371,65.21,37.46,5,0
    .goto 371,45.8,84.6,40 >>|cRXP_WARN_我们开始这个任务，将传送物品传送到这个区域。|r
...
step
    ...
    >>杀死|cRXP_ENEMY_Twinspire Peon|r
...
step
    ...
    .accept 31740 >>接任务: |cRXP_WARN_丧失理智的扣扣|r
    .target Lin Applebloom
step
    .goto 371,39.32,89.86
    >>杀死|cRXP_ENEMY_Koukou|r
...
step
    ...
    .accept 31741 >>接任务: |cRXP_WARN_双塔堡垒|r
    .accept 31744 >>接任务: |cRXP_WARN_不公平的交易|r
    .goto 371,46.26,84.72
    .target +Sunke Khang
    .accept 31742 >>接任务: |cRXP_WARN_内讧|r
    .accept 31743 >>接任务: |cRXP_WARN_空中打击|r
    .target +Rell Nightwind
    .goto 371,46.2,84.82
step
    #completewith Dalgan and Bellandra Felstorm
    >>杀死|cRXP_ENEMY_Ga’trul之眼|r以释放|cRXP_FRIENDLY_Pandaren Cubs|r
...
step
    ...
    >>杀死露台上的|cRXP_ENEMY_Dalgan|r和|cRXD_ENEMY_Bellandra Felstorm|r|cRXP_WARN_|r
...
step
    ...
    .accept 30070 >>接任务: |cRXP_WARN_消灭加图尔|r
    .target Sully“The Pickle”McLeary
step
    .goto 371,41.38,77.82
    >>杀死|cRXP_ENEMY_Ga'trul|r
...
step
    ...
    .accept 31745 >>接任务: |cRXP_WARN_继往开来|r
    .target Rell Nightwind
step
    .isOnQuest 31745
    .goto 371,41.46,79.84,10 >>离开圣殿|cRXP_WARN_不要点击陀螺仪|r
step
    #include 1） 玉林叛变侧题
step
...
step
    ...
    .accept 29555 >>接任务: |cRXP_WARN_白卒|r
    .accept 29556 >>接任务: |cRXP_WARN_是敌非友|r
    .target Sky Admiral Rogers
step
...
step
    .goto 371,49.8,90.18
    >>与船上的|cRXP_FRIENDLY_Alliance Bodyguard|r|cRXP-WARN_进行交互|r
    .complete 29555,1,1 --3/3 Clues found
    .target Alliance Bodyguard
step
    .goto 371,49.79,89.96,8,0
    .goto 371,50,90.28
    >>单击船侧的|cRXP_PICK_Fine Leather Journal|r|cRXP-WARN_in|r
...
step
    ...
    .accept 29553 >>接任务: |cRXP_WARN_失踪的海军上将|r
...
step
    ...
    .accept 29558 >>接任务: |cRXP_WARN_战争之路|r
    .accept 29559 >>接任务: |cRXP_WARN_拯救同胞|r
    .accept 29560 >>接任务: |cRXP_WARN_上古力量|r
...
step
    ...
    >>杀死|cRXP_ENEMY_Slingtail Hozens|r为|cRXP_Loot_|T133749:0|t竹钥匙|r
    .complete 29558,1 --12/12 Slingtail hozen slain
    .mob Slingtail Treeleaper
    .mob Slingtail Mudseer
step
    #completewith Prisoners freed
    >>单击地面上的|cRXP_PICK_Hozen Skulls|r|cRXP-WARN_|r
    .complete 29560,1 --8/8 Ancient Hozen Skull
step
    #label Prisoners freed
    >>单击|cRXP_PICK_Hozen Cages|r释放|cRXP_FRIENDLY_Alliance Prisons|r|cRXP_WARN_不要打开空笼子|r
...
step
    #completewith next
    >>杀死|cRXP_ENEMY_Slingtail Hozens|r为|cRXP_Loot_|T133749:0|t竹钥匙而掠夺它们|r
    .complete 29558,1 --12/12 Slingtail hozen slain
    .disablecheckbox
    .mob Slingtail Treeleaper
    .mob Slingtail Mudseer
step
    >>单击|cRXP_PICK_Hozen Skulls|r
    .complete 29560,1 --8/8 Ancient Hozen Skull
step
    #label Slingtail Hozen Camp loop
    >>杀死|cRXP_ENEMY_Slingtail Hozens|r
    .complete 29558,1 --12/12 Slingtail hozen slain
    .mob Slingtail Treeleaper
    .mob Slingtail Mudseer
step
    ...
    .accept 29759 >>接任务: |cRXP_WARN_恐钉|r
    .target Bold Karasshi
step
    .goto 371,54.65,80.12
    >>杀死|cRXP_ENEMY_Kung Din。|r掠夺他|cRXD_Loot_Slingtail密钥|r
...
step
    ...
    .target Bold Karasshi
    .accept 29562 >>接任务: |cRXP_WARN_越狱|r
step
    #loop
    ...
    >>杀死|cRXP_ENEMY_Slingtail Fishlripper|r
...
step
    ...
    .target Bold Karasshi
step
    #completewith 接任务: |cRXP_WARN_审时度势|r
    +|cRXP_WARN_等待角色扮演，当计时器用完时，角色扮演将完成|r|cFFFF0000整理行李并优化设备使用--x项。|r
step
    #label 接任务: |cRXP_WARN_审时度势|r
    .goto 371,58.93,81.93
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Rell Nightwind|r
    .accept 29883 >>接任务: |cRXP_WARN_审时度势|r
    .accept 29885 >>接任务: |cRXP_WARN_行军口粮|r
    .target Rell Nightwind
step
...
step
    ...
    >>杀死|cRXP_ENEMY_珍珠龟|r为|cRXP_Loot_Tortoise Flank掠夺它们|r
...
step
    ...
    .accept 29762 >>接任务: |cRXP_WARN_传家宝|r
    .goto 371,58.97,81.7
    .target +Pearlkeeper Fujin
    .accept 29887 >>接任务: |cRXP_WARN_长老的道具|r
    .goto 371,58.76,81.28
    .target +Bold Karasshi
-- step
--     #completewith Watersmithing
--     >>杀死|cRXP_ENEMY_Slingtail Stickypaw|r为|cRXP_Loot_Clothings抢劫它们|r
...
-- step
--     #completewith Watersmithing
--     >>与|cRXP_PICK_Dead Pearlfin Village|r交互以收集|cRXP _LOOT_Glassfin Heirlooms|r
